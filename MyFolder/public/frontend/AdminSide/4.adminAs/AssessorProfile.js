    ...
    updateAssignedApplicants: (applicants) => {
        ...
        applicants.forEach(applicant => {
            ...
            row.innerHTML = `
                ...
                <td>
                    <button class="action-btn view-btn" onclick="window.location.href='/Frontend/AdminSide/3.adminApp/adminAppProfile.html?id=${applicant._id}'">
...
const navigation = {
    ...
    editAssessor: () => {
        if (!currentAssessor) return;
        window.location.href = `/Frontend/AdminSide/4.adminAs/AssessorEdit.html?id=${currentAssessor._id}`;
    }
};
