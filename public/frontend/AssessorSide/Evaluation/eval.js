            ...
            if (evaluateBtn) {
                evaluateBtn.onclick = function(e) {
                    ...
                    fetchApplicantData(applicantId).then(() => {
                        if (currentApplicant) {
                            window.location.href = `/frontend/AssessorSide/Scoring/scoring.html?id=${applicantId}&applicantId=${currentApplicant.applicantId}`;
                        }
                    });
                };
            }
...
document.querySelector('.evaluate-button')?.addEventListener('click', function(e) {
    ...
    window.location.href = `/frontend/AssessorSide/Scoring/scoring.html?id=${currentApplicant._id}&applicantId=${currentApplicant.applicantId}`;
});
